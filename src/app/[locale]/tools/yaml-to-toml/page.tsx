...
database:
  ...
  const convertYamlToToml = () => {
    ...
    try {
      ...
      setError(t("tools.yaml-to-toml.invalid_yaml"))
      setOutput("")
    }
  }
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <div>
        <h1 className="text-3xl font-bold">{t("tools.yaml-to-toml.name")}</h1>
        <p className="text-muted-foreground mt-2">
          {t("tools.yaml-to-toml.description")}
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card>
          <CardHeader>
            <CardTitle>
              {t("tools.yaml-to-toml.input_title")}
            </CardTitle>
            <CardDescription>
              {t("tools.yaml-to-toml.input_desc")}
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <Textarea
              ...
              placeholder={t("tools.yaml-to-toml.placeholder")}
            ...
            <div className="flex gap-2">
              <Button onClick={convertYamlToToml} className="flex-1">
                {t("common.convert")}
              </Button>
        ...
        <Card>
          <CardHeader>
            <CardTitle>
              {t("tools.yaml-to-toml.output_title")}
            </CardTitle>
            <CardDescription>
              {t("tools.yaml-to-toml.output_desc")}
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <Textarea
              value={output}
              readOnly
              placeholder={t("tools.yaml-to-toml.output_placeholder")}
      ...
      {/* SEO 优化内容 */}
      <ToolSEOSection toolId="yaml-to-toml" />
    </div>
  )
}
